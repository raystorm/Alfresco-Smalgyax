 ...
 */
package com.github.raystorm.alfresco.smalgyax.platformsample;
...
public class DemoComponentIT extends AbstractAlfrescoIT {
    ...
    public void testGetCompanyHome() {
        DemoComponent demoComponent = (DemoComponent) getApplicationContext().getBean("com.github.raystorm.alfresco.smalgyax.DemoComponent");
